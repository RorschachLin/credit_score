...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Need an account?</span> <a href="<%=path %>/to_register" class="btn btn-danger">Create account</a><span>&nbsp&nbsp</span><a href="<%=path %>/to_bank_register" class="btn btn-danger">Bank register</a> </span>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
							<form action="<%=path%>/login" id="login-form" class="smart-form client-form" method="post">
								<header>
									Sign In
								</header>

				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
						<div class="well no-padding">
							...
							<form action="<%=path %>/add_customer" id="smart-form-register" class="smart-form client-form" method="post">
								<header>
									...
									<div class="row">
										...
										<section class="col col-6">
											<label class="input"> <i class="icon-append fa fa-calendar"></i>
												<input type="text" name="birthday" placeholder="Birth date" class="datepicker" data-dateformat='yy-mm-dd'>
											</label>
										</section>
									</div>

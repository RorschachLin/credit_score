...
<html lang="en-us" id="extr-page">
	<head>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<%=basePath %>css/smartadmin-rtl.min.css"> 
	...
	<body id="login">
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Already registered?</span> <a href="<%=path %>/" class="btn btn-danger">Sign In</a> </span>
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
						<h1 class="txt-color-red login-header-big">Bank Registration</h1>
						<div class="hero">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
						<div class="well no-padding">
							...
							<form action="<%=path %>/add_bank" id="smart-form-register" class="smart-form client-form" method="post">
								<header>
								...
								<fieldset>
									<section>
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input type="text" name="bankname" placeholder="Bankname">

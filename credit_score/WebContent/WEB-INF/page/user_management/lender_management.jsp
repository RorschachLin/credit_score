...
<body class="">
					...
					<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1"
						...
						<div>
							...
							<div class="widget-body no-padding">
								...
								<form action="<%=path%>/user/delete_lender_list" method="post"
									target="_self">
									...
									<table id="datatable_fixed_column"
										...
										<thead>
											...
											<tr>
												...
												<th onclick="sortTable(1)" data-hide="phone">Role</th>
												<th onclick="sortTable(2)" data-class="expand">Name</th>
												<th onclick="sortTable(3)">Email</th>
												<th onclick="sortTable(4)" data-hide="phone">Address</th>
												<th onclick="sortTable(5)" data-hide="phone,tablet">Postcode</th>
												<th onclick="sortTable(6)" data-hide="phone,tablet">principal</th>
												<th onclick="sortTable(7)" data-hide="phone,tablet">Tel</th>
												<th onclick="sortTable(8)" data-hide="phone,tablet">Applying</th>
												<th onclick="sortTable(9)" data-hide="phone,tablet">Authorization</th>
										...
										<tbody>
											...
											<c:forEach var="lender" items="${lenderList }">
												<tr>
								 					<td class="center"><input type="checkbox"
														name="deleteLender" value="${lender.lenderId }"></td>
													<td>${lender.roleId }</td>
													<td>${lender.name }</td>
													<td>${lender.email }</td>
													<td>${lender.address.addressOne }&nbsp;${lender.address.addressTwo }</td>
													<td>${lender.address.postcode }</td>
													<td>${lender.principal }</td>
													<td>${lender.tel }</td>
													<td>${lender.applyingTime }</td>
													<td><script>
														var authorizedTime = "${lender.authorizedTime }";
														
														if (authorizedTime == "") {
															document.write("not authorized");
														}else {
															document.write(authorizedTime);
														}
													</script></td>
													<td>
													<div class="row">
													<a href="<%=path%>/user/authorize_lender?lenderId=${lender.lenderId }"
														target="_self"  title="authorize this lender"> <span><i class="glyphicon glyphicon-ok"></i></span>
													</a> 
													<a href="#" data-href="<%=path %>/user/delete_lender?lenderId=${lender.lenderId }"
														data-toggle="modal" data-target="#confirm-delete" title="delete this lender"> <span class="glyphicon glyphicon-trash"></span>
													</a>
													<a href="<%=path%>/user/to_update_lender?lenderId=${lender.lenderId }" target="_self" title="update this lender"> <span class=""><i
	...
	//-------------- tooltip ---------------
		...
		function toogle(source) {
			//get all checkbox named deleteLender
			var checkboxes = document.getElementsByName('deleteLender');
			//check all of them
		...
		$('#confirm-delete').on(
				...
				function(e) {
					...
					$(this).find('.btn-ok').attr('target', "_self");

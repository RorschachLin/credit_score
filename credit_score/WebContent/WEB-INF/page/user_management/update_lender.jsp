...
<html>
	...
	<div class="input-group">
		<span class="input-group-addon"><i
			...
			class="form-control input-lg" data-mask="+99 (999) 999-9999"
			data-mask-placeholder="X" placeholder="+1" type="text" name="wphone"
			id="wphone">
	</div>
			...
			<div class="jarviswidget" id="wid-id-8" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<form action="<%=path %>/user/update_lender" method="post" id="contact-form" class="smart-form" target="_self">
							
							<header>Update form</header>
							<input type="hidden" name="lender_id" id="lid" value="${updateLender.lenderId }">
							<fieldset>					
								<div class="row">
									<section class="col col-6">
										...
										<label class="input">
											...
											<input type="email" name="email" id="email" value="${updateLender.email }">
										</label>
									</section>
									<section class="col col-6">
										...
										<label class="input">
											...
											<input type=text name="password" id="password" value="${updateLender.password }">
										</label>
									</section>
								</div>
								...
								<div class="row">
									<section class="col col-6">
										...
										<label class="input">
											<i class="icon-append fa fa-user"></i>
											<input type="text" name="name" id="name" value="${updateLender.name }">
										</label>
									</section>
									<section class="col col-6">
										...
										<label class="input">
											<i class="icon-append fa fa-envelope-o"></i>
											<input type="text" name="role" id="role" value="${updateLender.roleId }">
										</label>
									</section>
								</div>
								...
								<div class="row">
									...
									<section class="col col-6">
										...
										<label class="input">
											<i class="icon-append fa fa-envelope-o"></i>
											<input type="text" name="tel" id="tel" value="${updateLender.tel }">
										</label>
									</section>
								</div>
								...
								<div class="row">
									<section class="col col-6">
										<label class="label">Applying Time (in format: yyyy-mm-dd hh:mm:ss)</label>
										<label class="input">
											<i class="icon-append fa fa-envelope-o"></i>
											<!-- <input type="text" placeholder="Date" id="date" class="form-control" /> -->
											<input class="form-control" type="text" name="applying_time" id="apply_time" placeholder="yyyy-mm-dd hh:mm:ss" value="${updateLender.applyingTime }">
										</label>
									</section>
									<section class="col col-6">
										<label class="label">Authorization (null if unauthorized, date format: yyyy-mm-dd hh:mm:ss)</label>
										<label class="input">
											<i class="icon-append fa fa-envelope-o"></i>
											<!-- <input type="text" placeholder="Date" id="date" class="form-control" /> -->
											<input class="form-control" type="text" name="authorized_time" id="authorization" placeholder="yyyy-mm-dd hh:mm:ss" value="${updateLender.authorizedTime }">
										</label>
									</section>
								</div>
								...
								<section>
									...
									<label class="input">
										...
										<input type="text" name="principal" id="principal" value="${updateLender.principal }">
									</label>
								</section>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		...
		jQuery(document).ready(function(){
			...
			jQuery("#apply_time").mask("9999-99-99 99:99:99");
			jQuery("#authorization").mask("9999-99-99 99:99:99");
		});
